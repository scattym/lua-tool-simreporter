...
CONFIG["CRITICAL_SECTION_EVENT_HANDLER"] = 10
CONFIG["CRITICAL_SECTION_GPIO_HANDLER"] = 11
CONFIG["CRITICAL_SECTION_GPIO_LIST"] = 12
CONFIG["CRITICAL_SECTION_SOCKET_LIST"] = 13

CONFIG["WAIT_EVENT_SOCKET_SEND"] = 40
CONFIG["WAIT_EVENT_MESSAGE_QUEUE"] = 39

CONFIG["MAX_GPIO_EVENT_BACKLOG"] = 10
CONFIG["MAX_SOCKET_SEND_BACKLOG"] = 10
...
local MUST_BE_STRING = {
    ...
    "CHECK_FOR_FIRMWARE_IN_THREADS",
    "FIRMWARE_HOST",
    "CHECK_FOR_FIRMWARE_ON_BOOT",
