...
print("Message type concat ", type(table.concat(enc_login_message)))
print(util.tohex(table.concat(enc_login_message)))
...
enc = aes.encrypt_raw_key(raw_key, clear, aes.AES128, aes.CBCMODE)
clear = aes.decrypt_raw_key(raw_key, enc, aes.AES128, aes.CBCMODE)
print(enc)
print(clear)